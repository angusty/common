...
define('DISCUZ_DATADIR', DISCUZ_ROOT . './data/');
define('DISCUZ_DATAURL', DISCUZ_API . '/data');

if (!function_exists('uc_addslashes')) {
...
if (!function_exists('uc_stripslashes')) {
...
if (!function_exists('uc_api_post')) {
...
if (!function_exists('uc_api_input')) {
...
if (!function_exists('uc_api_mysql')) {
...
if (!function_exists('uc_feed_add')) {
...
if (!function_exists('uc_feed_get')) {
...
if (!function_exists('uc_friend_add')) {
...
if (!function_exists('uc_friend_delete')) {
...
if (!function_exists('uc_friend_totalnum')) {
...
if (!function_exists('uc_friend_ls')) {
...
if (!function_exists('uc_user_register')) {
    function uc_user_register($username, $password, $email, $openid, $questionid = '', $answer = '', $regip = '')
    {
...
if (!function_exists('uc_checkUserExist')) {
    function uc_checkUserExist($openid)
    {
        return call_user_func(UC_API_FUNC, 'user', 'checkopenid', array(
            'openid' => $openid
        ));
    }
}

if (!function_exists('uc_checkUserNameExist')) {
    function uc_checkUserNameExist($username)
    {
        return call_user_func(UC_API_FUNC, 'user', 'checkuser', array(
            'username' => $username
        ));
    }
}
...
if (!function_exists('uc_band_openid')) {
    function uc_band_openid($username, $openid, $is_weixinlogin = '0')
    {
        return call_user_func(UC_API_FUNC, 'user', 'modopenid', array(
            'username' => $username,
            'openid' => $openid,
            'is_weixinlogin' => $is_weixinlogin
        ));
    }
}
...
if (!function_exists('uc_user_deleteavatar')) {
...
if (!function_exists('uc_user_checkemail')) {
...
if (!function_exists('uc_user_addprotected')) {
...
if (!function_exists('uc_user_deleteprotected')) {
...
if (!function_exists('uc_user_getprotected')) {
...
if (!function_exists('uc_user_merge')) {
...
if (!function_exists('uc_user_merge_remove')) {
...
if (!function_exists('uc_user_getcredit')) {
...
if (!function_exists('uc_pm_location')) {
...
if (!function_exists('uc_pm_checknew')) {
...
if (!function_exists('uc_pm_delete')) {
...
if (!function_exists('uc_pm_deleteuser')) {
...
if (!function_exists('uc_pm_deletechat')) {
...
if (!function_exists('uc_pm_readstatus')) {
...
if (!function_exists('uc_pm_ignore')) {
...
if (!function_exists('uc_pm_view_num')) {
...
if (!function_exists('uc_pm_viewnode')) {
...
if (!function_exists('uc_pm_chatpmmemberlist')) {
...
if (!function_exists('uc_pm_kickchatpm')) {
...
if (!function_exists('uc_pm_appendchatpm')) {
...
if (!function_exists('uc_pm_blackls_get')) {
...
if (!function_exists('uc_pm_blackls_set')) {
...
if (!function_exists('uc_pm_blackls_add')) {
...
if (!function_exists('uc_pm_blackls_delete')) {
...
if (!function_exists('uc_domain_ls')) {
...
if (!function_exists('uc_credit_exchange_request')) {
...
if (!function_exists('uc_mail_queue')) {
 ...
 * 根据uid修改用户名
 */
if (!function_exists('uc_update_member_by_uid')) {
    function uc_update_member_by_uid($uid, $username)
    {
        return call_user_func(UC_API_FUNC, 'user', 'update_member_by_uid', array(
            'uid' => $uid,
            'username' => $username
        ));
    }
...
//调用远程url接口
if (!function_exists('discuz_api_url')) {
    function discuz_api_url($module, $action, $arg = '', $extra = '')
    {
        $arg = http_build_query($arg);
        $data = "&action={$action}&time=" . time();
        $string = urlencode(uc_authcode($arg . $data, 'ENCODE', DISCUZ_KEY, 3600)); //关键步奏
        //组装url
        $url = DISCUZ_API . '?code=' . $string; //组装成 ？code=加密字段 形式，UC_API，UC_API地址
